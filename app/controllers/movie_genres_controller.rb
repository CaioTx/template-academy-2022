class MovieGenresController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @movie_genre.save
        format.html { redirect_to movie_genre_url(@movie_genre), notice: "Genero criado com sucesso." }
  ...
  def update
    respond_to do |format|
      if @movie_genre.update(movie_genre_params)
        format.html { redirect_to movie_genre_url(@movie_genre), notice: "Genero editado com sucesso." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to movie_genres_url, notice: "Genero deletado com sucesso." }
  ...
  private
    ...
    def movie_genre_params
      params.require(:movie_genre).permit(:name, :create_date)
    end
end
