class DirectorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @director.save
        format.html { redirect_to director_url(@director), notice: "Diretor criado com sucesso." }
  ...
  def update
    respond_to do |format|
      if @director.update(director_params)
        format.html { redirect_to director_url(@director), notice: "Diretor editado com sucesso." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to directors_url, notice: "Diretor deletado com sucesso." }
  ...
  private
    ...
    def director_params
      params.require(:director).permit(:name, :create_date)
    end
