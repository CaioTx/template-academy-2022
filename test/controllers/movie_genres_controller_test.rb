...
class MovieGenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movie_genre" do
    assert_difference("MovieGenre.count") do
      post movie_genres_url, params: { movie_genre: { create_date: @movie_genre.create_date, name: @movie_genre.name } }
    end
  ...
  test "should update movie_genre" do
    patch movie_genre_url(@movie_genre), params: { movie_genre: { create_date: @movie_genre.create_date, name: @movie_genre.name } }
